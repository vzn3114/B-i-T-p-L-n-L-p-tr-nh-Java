...
import '../../assets/TreatmentPlan.css';
  ...
  <>
    ...
    <div className="treatment-plan-container">
      ...
      <form className="treatment-plan-form">
        <label>Chỉ định mũi tiêm tiếp theo <span role="img" aria-label="syringe">💉</span>:</label>
        <input type="text" placeholder="Nhập chỉ định..." />
        <label>Hẹn lịch tái khám <span role="img" aria-label="calendar">📅</span>:</label>
        <input type="date" />
